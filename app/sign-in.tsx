        ...
        <SafeAreaView className="bg-white h-full">
            <ScrollView contentContainerClassName="h-full">
                ...
                <View>
                    ...
                    <TouchableOpacity onPress={handLogin} className="bg-white shadow-md shadow-zinc-200 rounded-full w-11/12 py-4 mt-5 self-center">                        <View className="flex flex-row  items-center justify-center">
                            <Image
                                source={icons.google}
                                className="w-5 h-5"
                                resizeMode="contain" />
